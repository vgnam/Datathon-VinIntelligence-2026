...
print("="*70)
print("TRAIN ML MODELS WITH SELECTED FEATURES + LOG TRANSFORM")
print("="*70)
...
if not TRAIN_FEATURES.exists():
    raise FileNotFoundError(f"Missing {TRAIN_FEATURES}. Run train_selected_features.py first.")
...
# ============================================
print("\n" + "="*70)
print("6. RANDOM FOREST (Log Target, Selected Features)")
print("="*70)
...
# ============================================
print("\n" + "="*70)
print("7. LIGHTGBM (Log Target, Selected Features)")
print("="*70)
...
# ============================================
print("\n" + "="*70)
print("8. XGBOOST (Log Target, Selected Features)")
print("="*70)
...
try:
    ...
    results.append({"target": "Revenue", "model": "XGB_selected_log",
        "MAPE": mape(y_val_raw['Revenue'], val_pred_rev), "SMAPE": smape(y_val_raw['Revenue'], val_pred_rev),
        "R2": r2(y_val_raw['Revenue'], val_pred_rev), "SSE": sse(y_val_raw['Revenue'], val_pred_rev)})
    results.append({"target": "COGS", "model": "XGB_selected_log",
        "MAPE": mape(y_val_raw['COGS'], val_pred_cogs), "SMAPE": smape(y_val_raw['COGS'], val_pred_cogs),
        "R2": r2(y_val_raw['COGS'], val_pred_cogs), "SSE": sse(y_val_raw['COGS'], val_pred_cogs)})
...
# ============================================
print("\n" + "="*70)
print("9. EXTRATREES (Log Target, Selected Features)")
print("="*70)
...
# ============================================
# 10. ENSEMBLE (Inverse MAPE weights)
# ============================================
print("\n" + "="*70)
print("10. ENSEMBLE (RF + XGB + LGB + ET, Selected Features)")
print("="*70)
...
# ============================================
print("\n" + "="*70)
print("11. SUMMARY: SELECTED FEATURES + LOG TRANSFORM")
print("="*70)
...
for name, pred_df in [("rf_selected_log", rf_test_pred), ("lgb_selected_log", lgb_test_pred),
                       ("xgb_selected_log", xgb_test_pred), ("et_selected_log", et_test_pred)]:
