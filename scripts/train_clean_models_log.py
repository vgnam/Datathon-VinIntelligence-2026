...
print("="*60)
print("TRAINING ML MODELS WITH CLEANED FEATURES + LOG TRANSFORM")
print("="*60)
...
print(f"\nRevenue range:      {train['Revenue'].min():,.0f} to {train['Revenue'].max():,.0f}")
...
# ============================================
print("\n" + "="*60)
print("1. RANDOM FOREST (Log Target)")
print("="*60)
...
results.append({
    "target": "Revenue", "model": "RandomForest_log",
...
results.append({
    "target": "COGS", "model": "RandomForest_log",
...
results.append({
    "target": "Revenue", "model": "ExtraTrees_log",
...
results.append({
    "target": "COGS", "model": "ExtraTrees_log",
...
# ============================================
print("\n" + "="*60)
print("SUMMARY: CLEANED FEATURES + LOG TRANSFORM")
print("="*60)
